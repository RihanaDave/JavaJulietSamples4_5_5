/*
 * @description demonstrates good nonreentrant pattern using synchronization.
 * 
 * */
...
public class CWE663_Use_Non_Reentrant_Function_Unsync__console_synchronized_01_good1
		extends AbstractTestCaseClassIssueGood 
{

	int test = 0;
	
	private synchronized int good_nonreentrant(int inte) /* FIX: synchronized */
	{
		test = inte * 2;
		return test;
	}
	...
	private void good1() throws IOException
    {
        ...
        try
        {
            ...
            {
                IO.writeLine("Error, that's not a number");
                errored = true;
            }
