/*
 * @description demonstrates bad nonreentrant pattern without synchronization.
 * 
 * */
...
public class CWE663_Use_Non_Reentrant_Function_Unsync__console_synchronized_01_bad
		extends AbstractTestCaseClassIssueBad 
{

	int test = 0;
	
	private int bad_nonreentrant(int inte) /* FLAW: not synchronized */
	{
		test = inte * 2;
		return test;
	}
